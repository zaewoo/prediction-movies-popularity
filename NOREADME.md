...
### 3.4. 데이터: 종합
학습 모델에 사용할 전체 데이터는 다음과 같습니다. 전체 데이터는 약 7천 개이고, 전체 데이터의 컬럼은 10개입니다.
...
- 위의 표에서 **Zombieland**, 그리고 **Creed**가 국내에서 상영하였을 때 가장 많은 관객이 동원될 것으로 예상했다.
...
- 그리고 **Rotten Tomatoes**에서 US Box Office ($)를 찾아 본 결과, **Zombieland**, 그리고 **Creed**는 총 $100m 이상의 매출을 기록했습니다. 
- 미국에서 백만 이상의 관객을 동원한 영화는 매출 면에서 $100m 가까이 보여주었기 때문에 학습 모델의 예측이 적합하다고 보았습니다. 
